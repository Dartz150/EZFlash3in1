/**************************************************************************************************************
 *  EZ 3in1 dsCard.cpp write NOR/PSRAM
 *  EZTeam
 **************************************************************************************************************/
#include "dscard.h"
#include "string.h"
...
uint32 ReadNorFlashID()
{
	...
	*((vuint16 *)(FlashBase + 0x1555 * 2)) = 0x90;
	...
	//check Altera 256M new3in1 card V2	
...
//			_consolePrintf("WriteNorFlashINTEL begin 1\n");
			...
			*((vu16 *)(FlashBase + mapaddress + (loopwrite >> 1) + 0x2000)) = 0x0F;
			...
			for(i = 0; i < 0x10; i++)
			{
				...
				*((vu16 *)(FlashBase + mapaddress + 0x2000 + (loopwrite >> 1) + i * 2))
				 = buf[0x1000 + (loopwrite >> 2) + i];
			}
